...
namespace Overlay.NET.Common
{
	...
	public class Font : IDisposable
	{
        ...
        public Font(FontFactory factory, System.Drawing.Font pFont)
        {
			TextFormat = new TextFormat(factory, pFont.FontFamily.Name, pFont.Bold ? FontWeight.Bold : FontWeight.Normal, pFont.Italic ? FontStyle.Italic : FontStyle.Normal, pFont.Size);
		}
