...
namespace Overlay.NET.Common
{
	...
	public class Geometry : IDisposable
	{
		...
		public Geometry(Direct2DRenderer device)
		{
			this.direct2DRenderer = device;
		...
		public void BeginFigure(System.Drawing.Point point, bool fill = false)
		{
			_sink.BeginFigure(
				new RawVector2(point.X, point.Y), 
		...
		/// <param name="fill">A Boolean value determining whether this figure can be filled by a Graphics device.</param>
		public void BeginLine(System.Drawing.Point StartPoint, System.Drawing.Point EndPoint, bool fill = false)
		{
			_sink.BeginFigure(new RawVector2(StartPoint.X, StartPoint.Y), fill ? FigureBegin.Filled : FigureBegin.Hollow);
			_sink.AddLine(new RawVector2(EndPoint.X, EndPoint.Y));
		}
		...
		{
			_sink.AddLine(new RawVector2(point.X, point.Y));
		}
		...
		/// <param name="fill">A Boolean value determining whether this figure can be filled by a Graphics device.</param>
		public void AddRectangle(System.Drawing.Rectangle rectangle, bool fill = false)
		{
		...
		public void AddCurve(System.Drawing.Point point, float radius, float rotationAngle = 0.0f)
		{
			...
			var arc = new ArcSegment()
			{
				...
				Point = new RawVector2(point.X, point.Y),
		...
		/// <param name="rotationAngle">A value determining the rotation angle this curve.</param>
		public void AddCurve(System.Drawing.Point point, float radius_x, float radius_y, float rotationAngle = 0.0f)
		{
		...
		private Direct2DRenderer direct2DRenderer;
